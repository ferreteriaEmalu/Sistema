...
function menuInicio(permisos) {
    ...
    if (permisos[4]) {
        ...
        menu.innerHTML += `<a class="list-group-item list-group-item-action bg-light" onclick="pedidosGenerales()" 
                    ...
                    menu.innerHTML += `<a class="list-group-item list-group-item-action bg-light" onclick="hacerVenta()" 
                    href="#">Hacer venta</a>`;
    ...
    <div >
        <article id="tab1">
            ...
            <center>
                ...
                <datalist class="form-select" id="productos"></datalist>
                <datalist class="form-select" id="clientes"> </datalist>
                <br><button class="btn btn-primary" onclick="Emitir2()">Emitir</button>
                    <br><br>
            </center>
            <div class="overflow-auto">
                <table>
